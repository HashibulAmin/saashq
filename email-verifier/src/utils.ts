...
export const debugBase = debug('saashq-email-verifier:base');
export const debugCrons = debug('saashq-email-verifier:crons');
export const debugError = debug('saashq-email-verifier:error');
