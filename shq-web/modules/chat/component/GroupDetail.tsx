    ...
    if (chatDetail && chatDetail.featuredImage.length > 0) {
      return (
        <Image
          ...
          width={60}
          height={60}
          className={`w-16 h-16 rounded-full object-cover border-shq border-4`}
        />
      )
    }
    ...
    return (
      <div className="relative">
        <Image
          ...
          width={60}
          height={60}
          className={`w-[50px] h-[50px] rounded-full object-cover absolute right-0 border-shq border-2`}
        />
        <Image
          src={
          ...
          width={60}
          height={60}
          className={`w-[50px] h-[50px] top-[28px] rounded-full object-cover absolute  border-shq border-2`}
        />
      </div>
    )
  }
