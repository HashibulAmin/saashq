...
const ChatList = () => {
      ...
      <div>
        <div className="flex">
          {["Chat", "Groups"].map((type, index) => (
            <button
              key={index}
              className={`py-3 px-4 flex-1 flex items-center gap-2 justify-center border-b-2 border-shq ${
            ...
            >
              ...
              {renderUnreadCount(type) > 0 && (
                <div className="">
                  <span className="bg-primary text-white rounded-lg w-5 h-5 flex items-center justify-center text-[10px] border border-shq">
  ...
  return (
    <div className="w-full overflow-auto h-screen">
      ...
      <div className="px-3 pb-4 border-b border-shq">
        <Input
