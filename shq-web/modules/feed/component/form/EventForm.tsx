    ...
    return (
      <>
        <div className="flex justify-center gap-6 mb-6 h-[calc(100%-65px)]">
          ...
          <div className="border border-shq rounded-md max-w-[566px] w-full h-full">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormControl>
                        <Textarea
                          className="rounded-md px-3 py-2 border-shq"
                        ...
                        <FormControl>
                          <Popover>
                            <PopoverTrigger className="w-full">
                              <div className="cursor-pointer flex rounded-md px-3 py-2 border items-center w-full border-shq">
                            ...
                            <PopoverContent className="w-[305px] shadow-none p-2 border-shq">
                              <DateTimePicker
                    ...
                    <FormItem className="h-[calc(100%-24px)] min-h-[50px]">
                      <FormControl>
                        <Textarea
                          ...
                          className="border-shq !h-full !max-h-[unset] bg-[#FCFCFD]"
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
