...
class MessagesList extends React.Component<Props, State> {
  ...
  componentDidMount() {
    ...
    if (this.node) {
      ...
      makeClickableLink('#saashq-messages a');
    }
  }
  ...
  renderAwayMessage(messengerData: IIntegrationMessengerData) {
    ...
    return (
      <li className="saashq-spacial-message right away">{messages.away}</li>
    );
  }
  ...
  renderNotifyInput(messengerData: IIntegrationMessengerData) {
    ...
    if (this.state.hideNotifyInput) {
      ...
      return (
        <li className="saashq-spacial-message with-background">
    ...
    return (
      <li className="saashq-spacial-message with-background auth">
        <AccquireInformation
          save={this.onNotify}
          color={getColor}
          loading={false}
  ...
  renderWelcomeMessage(messengerData: IIntegrationMessengerData) {
    ...
    return <li className="saashq-spacial-message right">{messages.welcome}</li>;
  }
      ...
      <div className="skill-content">
        {options.map((option, index) => {
          ...
          return (
            <div key={index}>
              <div
                className="skill-card saashq-button"
                onClick={handleClick}
  ...
  renderSkillResponse = () => {
    ...
    return (
      <li className="from-customer">
        <div className="saashq-message from-customer gray">
  ...
  renderTyping() {
    ...
    return (
      <li>
        <Bot />
        <div className="saashq-message top">
  ...
  render() {
    ...
    const backgroundClass = classNames('saashq-messages-background', {
      [`bg-${uiOptions.wallpaper}`]: uiOptions.wallpaper
    });

    return (
      <div className={backgroundClass} ref={node => (this.node = node)}>
        <ul id="saashq-messages" className="saashq-messages-list slide-in">
