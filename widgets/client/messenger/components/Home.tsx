...
class Home extends React.Component<Props, State> {
  ...
  renderTab() {
    ...
    return (
      <div className="saashq-tab" onClick={this.toggleTab}>
        <div
  ...
  renderHead() {
    ...
    return (
      <div
        className={classNames("saashq-welcome", {
  ...
  render() {
    ...
    return (
      <div
        className="saashq-home-container"
        style={{ paddingTop: this.state.headHeight }}
      >
        <TopBar middle={this.renderHead()} />
        <div
          className={classNames("saashq-home-content", {
            tabbed: topicId,
          })}
        >
          <RTG.CSSTransition
            ...
            classNames="slide"
          >
            <div className="saashq-home-item">
              <Integrations />
            </div>
          </RTG.CSSTransition>
          ...
          <RTG.CSSTransition
            ...
            unmountOnExit={true}
          >
            <div className="saashq-home-item seperate">
