...
class ConversationDetail extends React.Component<Props, State> {
  ...
  render() {
    ...
    const rootClasses = classNames('saashq-content-wrapper', {
    ...
    const handleLeftClick = (e: React.FormEvent<HTMLButtonElement>) => {
      ...
      const videoIframe = document.getElementById('saashq-video-iframe');
    ...
    return (
      <div className="saashq-conversation-detail" onWheel={this.onWheel}>
        <TopBar
          middle={
        ...
        <div className="saashq-conversation-content">
