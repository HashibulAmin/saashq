...
class Form extends React.Component<Props, State> {
    ...
    const button = (
      ...
      return (
        <button
          ...
          type="button"
          onClick={action}
          className={`saashq-button btn-block ${
  ...
  renderForm() {
    ...
    return (
      <div className="saashq-form">
        {this.renderHead(form.title || integration.name)}
        {this.renderProgress()}
        <div className="saashq-form-content">
          <div className="saashq-description">{form.description}</div>

          {extraContent ? (
            <div dangerouslySetInnerHTML={{ __html: extraContent }} />
          ) : null}

          <div className="saashq-form-fields">{this.renderFields()}</div>
  ...
  renderSuccessForm(
    ...
    return (
      <div className="saashq-form">
        ...
        <div className="saashq-form-content">
          <div className="saashq-callout-body">
