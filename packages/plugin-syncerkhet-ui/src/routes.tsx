...
const routes = () => {
  return (
    <React.Fragment>
      <Route
        key="/saashq-plugin-sync-erkhet/settings/general"
        exact={true}
        path="/saashq-plugin-sync-erkhet/settings/general"
        component={GeneralSetting}
      />

      <Route
        key="/saashq-plugin-sync-erkhet/settings/stage"
        exact={true}
        path="/saashq-plugin-sync-erkhet/settings/stage"
        component={StageSetting}
      />

      <Route
        key="/saashq-plugin-sync-erkhet/settings/move-stage"
        exact={true}
        path="/saashq-plugin-sync-erkhet/settings/move-stage"
        component={StageMoveSetting}
      />

      <Route
        key="/saashq-plugin-sync-erkhet/settings/income-stage"
        exact={true}
        path="/saashq-plugin-sync-erkhet/settings/income-stage"
        component={StageIncomeSetting}
      />

      <Route
        key="/saashq-plugin-sync-erkhet/settings/return-stage"
        exact={true}
        path="/saashq-plugin-sync-erkhet/settings/return-stage"
        component={ReturnStageSetting}
      />

      <Route
        key="/saashq-plugin-sync-erkhet/settings/pipeline"
        exact={true}
        path="/saashq-plugin-sync-erkhet/settings/pipeline"
