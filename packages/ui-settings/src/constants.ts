  ...
  steps: [
    ...
    },
    {
      ...
      description: `${__('Click on Download Template for importing')}.${__(
        'This is an important step, because your column titles need to match with saashq titles',
      )}`,
      isOutside: false,
    },
    {
  ...
  steps: [
    {
      title: __('Create Custom Properties'),
      description: __(
        'If you wish to segment by any properties that are not available on saashq, make sure you’ve already created them',
      ),
...
export const EMPTY_CONTENT_POPUPS = {
  ...
  steps: [
    ...
    },
    {
      title: 'Install the script',
      description: __(
        'Copy the individual script or use Script Manager to avoid script duplication errors if you’re planning to display this form along with any other saashq widgets',
      ),
...
export const EMPTY_CONTENT_KNOWLEDGEBASE = {
  ...
  steps: [
    ...
    },
    {
      ...
      description:
        "<ul><li>Copy the individual script by clicking on the Settings button.</li><li>Use <a href='/settings/scripts'>Script Manager</a> to avoid script duplication errors if you’re planning to display this popup along with any other saashq widgets</li></ul>",
      html: true,
      url: '/settings/scripts',
      urlText: __('Go to Script Manager'),
    },
