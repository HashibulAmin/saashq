...
class DealChooser extends React.Component<FinalProps, State> {
  constructor(props) {
    ...
    const { boardId, companyId, stageId, pipelineId } = JSON.parse(
      localStorage.getItem('saashq_deals:chooser_filter') || '{}'
    );
