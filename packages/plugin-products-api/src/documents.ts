import { dateToShortStr } from '@saashq/api-utils/src/core';
...
export default {
  ...
  replaceContent: async ({
    ...
    if (content.includes('{{ barcode }}')) {
      results.push(
        '::heads::<script src="https://nmgplugins.s3.us-east-1.amazonaws.com/JsBarcode.all.min.js"></script><script src="https://nmgplugins.s3.us-east-1.amazonaws.com/ebarimt/jquery.js"></script>'
      );
    }
