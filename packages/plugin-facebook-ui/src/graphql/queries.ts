...
const facebookGetIntegrationDetail = `
  query facebookGetIntegrationDetail($saashqApiId: String) {
    facebookGetIntegrationDetail(saashqApiId: $saashqApiId)
  }
`;
...
const facebookGetPost = `
  query facebookGetPost($saashqApiId: String) {
    facebookGetPost(saashqApiId: $saashqApiId) {
      _id
      ${commonPostAndCommentFields}
    }
  }
