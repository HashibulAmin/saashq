...
import { __, readFile } from '@saashq/ui/src/utils/core';
...
import {
  CardContent,
  CardItem,
} from '@saashq/ui-inbox/src/inbox/components/conversationDetail/workarea/conversation/messages/bot/styles';
import { Row } from '@saashq/ui-settings/src/styles';
import { AvatarImg } from '@saashq/ui/src/components/filterableList/styles';
...
function Preview({ messages }) {
  ...
  const renderCard = (
    ...
    return (
      <MesageRow>
        {!isCarousel && <AvatarImg src="/images/saashq-bot.svg" />}
        <Message>
  ...
  const renderCards = (cards) => {
    ...
    return (
      <CarouselContainer>
        <MesageRow>
          <AvatarImg src="/images/saashq-bot.svg" />
