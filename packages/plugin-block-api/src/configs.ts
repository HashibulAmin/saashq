  ...
  onServerInit: async (options) => {
    ...
    app.post(
      ...
      routeErrorHandling(async (req, res) => {
        ...
        //   const saashqCustomerId = customer._id;

        //   if (customer) {
        //     console.log('3', saashqCustomerId);
        //     const balance = await getBalance(subdomain, saashqCustomerId);
        ...
        //     try {
        //       await updateBalance(subdomain, saashqCustomerId, newBalance);
