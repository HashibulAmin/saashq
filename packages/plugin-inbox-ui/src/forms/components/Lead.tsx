...
import { IAttachment, IConditionsRule } from '@saashq/ui/src/types';
import { ILeadData, ILeadIntegration } from '@saashq/ui-leads/src/types';
...
import { Content } from '@saashq/ui-inbox/src/settings/integrations/styles';
import { ControlWrapper } from '@saashq/ui/src/components/step/styles';
import { IConfig } from '@saashq/ui-settings/src/general/types';
import { IField } from '@saashq/ui/src/types';
import { IFormData } from '@saashq/ui-forms/src/forms/types';
import { Indicator } from '@saashq/ui/src/components/step/styles';
import { LeftContent } from '@saashq/ui-inbox/src/settings/integrations/styles';
import { Link } from 'react-router-dom';
import { PreviewWrapper } from '@saashq/ui/src/components/step/style';
        ...
        <Content>
          <LeftContent>
            <Steps>
              ...
              <Step
                img="/images/icons/saashq-03.svg"
                title="CallOut"
                onClick={this.onStepClick}
              >
                <CallOut
              ...
              <Step
                img="/images/icons/saashq-12.svg"
                title={'Content'}
                onClick={this.onStepClick}
              >
                <FormStep
              ...
              <Step
                img="/images/icons/saashq-06.svg"
                title="Options"
                onClick={this.onStepClick}
              >
                <OptionStep
              ...
              <Step
                img="/images/icons/saashq-05.svg"
              ...
              <Step
                img="/images/icons/saashq-13.svg"
                title="Confirmation"
                onClick={this.onStepClick}
                noButton={true}
              >
