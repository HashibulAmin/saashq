...
} from '@saashq/ui-forms/src/forms/types';
...
import { IntegrationDetailQueryResponse } from '@saashq/ui-inbox/src/settings/integrations/types';
import { LeadIntegrationDetailQueryResponse } from '@saashq/ui-inbox/src/settings/integrations/types';
