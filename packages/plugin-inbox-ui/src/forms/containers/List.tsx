...
import { IRouterProps, MutationVariables } from '@saashq/ui/src/types';
import { mutations, queries } from '@saashq/ui-leads/src/graphql';

import { ArchiveIntegrationResponse } from '@saashq/ui-inbox/src/settings/integrations/types';
...
import { mutations as integrationMutations } from '@saashq/ui-inbox/src/settings/integrations/graphql/index';
...
class ListContainer extends React.Component<FinalProps> {
  ...
  render() {
    ...
    const archive = (integrationId: string, status: boolean) => {
      let message = `If you archive this form, the live form on your website or saashq messenger will no longer be visible. But you can still see the contacts and submissions you've received.`;
      let action = 'archived';
