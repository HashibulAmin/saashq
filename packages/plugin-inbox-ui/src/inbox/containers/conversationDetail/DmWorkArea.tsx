...
import {
  ...
  queries,
  subscriptions
} from '@saashq/ui-inbox/src/inbox/graphql';
import { sendDesktopNotification, withProps } from '@saashq/ui/src/utils';
...
import { isConversationMailKind } from '@saashq/ui-inbox/src/inbox/utils';
