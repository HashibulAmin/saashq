...
import { PopoverButton } from '@saashq/ui-inbox/src/inbox/styles';
...
const Participators = asyncComponent(
  () =>
    import(
      /* webpackChunkName:"Inbox-Participators" */ '@saashq/ui-inbox/src/inbox/components/conversationDetail/workarea/Participators'
    ),
