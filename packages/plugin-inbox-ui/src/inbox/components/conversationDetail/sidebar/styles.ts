import { ActivityContent, DateContainer } from '@saashq/ui/src/styles/main';
import {
  ActivityDate,
  ActivityIcon,
  ActivityRow,
...
import {
  ...
  Reply,
  RightSide
} from '@saashq/ui-inbox/src/inbox/components/conversationDetail/workarea/mail/style';
import {
  FormTable,
  MessageBody,
  MessageContent,
  MessageItem,
  UserInfo
} from '@saashq/ui-inbox/src/inbox/components/conversationDetail/workarea/conversation/styles';
...
import { CardItem } from '@saashq/ui-inbox/src/inbox/components/conversationDetail/workarea/conversation/messages/bot/styles';
