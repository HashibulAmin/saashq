...
import { CountQueryResponse } from '@saashq/ui-leads/src/types';
import { INTEGRATION_KINDS } from '@saashq/ui/src/constants/integrations';
import { MutationVariables as RemoveMutationVariables } from '@saashq/ui/src/types';
...
function BookingListContainer(props: FinalProps) {
  ...
  const archive = (integrationId: string, status: boolean) => {
    let message = `If you archive this booking, the live booking on your website or saashq messenger will no longer be visible. But you can still see the contacts and submissions you've received.`;
    let action = 'archived';
