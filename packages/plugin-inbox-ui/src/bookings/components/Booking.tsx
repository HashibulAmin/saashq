...
import { IForm, IFormData } from '@saashq/ui-forms/src/forms/types';
...
import FullPreview from '@saashq/ui/src/components/step/FullPreview';
...
import SuccessStep from '@saashq/ui-leads/src/components/step/SuccessStep';
  ...
  return (
    <StepWrapper>
      ...
      <Content>
        <LeftContent>
          <Steps>
            <Step img="/images/icons/saashq-04.svg" title="Style">
              <StyleStep
            ...
            <Step img="/images/icons/saashq-09.svg" title="Content">
              <ContentStep
                onChangeBooking={onChangeBooking}
                name={booking.name}
                description={booking.description}
            ...
            <Step img="/images/icons/saashq-01.svg" title="Settings">
              <SettingsStep
                onChange={onChange}
                title={state.title}
                brandId={state.brandId}
