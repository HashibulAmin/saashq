...
import { Description } from '@saashq/ui-inbox/src/settings/integrations/styles';
    ...
    return (
      <>
        ...
        <FormGroup>
          ...
          <Description>
            {__(
              'This token will be used to sign the incoming payload, so that saashq can verify that the request came from trusted sources.'
            )}
          </Description>
          <FormControl
            {...formProps}
        ...
        <FormGroup>
          ...
          <Description>
            {
              'Enter the IP address of the host that sending request payload, so that saashq can verify that the request came from trusted sources.'
            }
          </Description>
          <FormControl
            {...formProps}
