...
import { linkify } from '@saashq/ui-inbox/src/inbox/utils';
...
class CreateMessenger extends React.Component<Props, State> {
  constructor(props: Props) {
    ...
    this.state = {
      ...
      logo: uiOptions.logo || '',
      logoPreviewStyle: {},
      logoPreviewUrl: uiOptions.logo || '/images/saashq.png',
        ...
        <Content>
          <LeftContent>
            <Steps>
              ...
              <Step
                img="/images/icons/saashq-09.svg"
                title="Greeting"
              ...
              <Step
                img="/images/icons/saashq-15.svg"
                title={__('Add Ons')}
