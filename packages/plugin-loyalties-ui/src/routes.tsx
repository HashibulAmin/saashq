...
const routes = () => {
  return (
    <>
      <Route
        path="/saashq-plugin-loyalty/settings/general"
        component={Settings}
      />

      <Route
        path="/saashq-plugin-loyalty/settings/voucher"
        component={voucherCampaignList}
      />

      <Route
        path="/saashq-plugin-loyalty/settings/lottery"
        component={lotteryCampaignList}
      />

      <Route
        path="/saashq-plugin-loyalty/settings/spin"
        component={spinCampaignList}
      />

      <Route
        path="/saashq-plugin-loyalty/settings/donate"
        component={donateCampaignList}
      />

      <Route
        path="/saashq-plugin-loyalty/settings/assignment"
        exact={true}
        component={assignmentCampaignList}
      />

      <Route
        path="/saashq-plugin-loyalty/settings/assignment/create"
        exact={true}
        component={assignmentCampaignCreate}
      />

      <Route
        path="/saashq-plugin-loyalty/settings/assignment/edit"
