...
import { Alert, getEnv, withProps } from '@saashq/ui/src/utils';
import { DefaultColumnsConfigQueryResponse, IConfigColumn } from '../types';

import { COLUMN_CHOOSER_EXCLUDED_FIELD_NAMES } from '@saashq/ui-settings/src/constants';
...
const ManageColumnsContainer = (props: FinalProps) => {
  ...
  const storageKey = isImport
    ? `saashq_${contentType}_columns_config_import`
    : `saashq_${contentType}_columns_config`;
