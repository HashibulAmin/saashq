...
export default function Form(props: Props) {
  ...
  return (
    <StepWrapper>
      <Steps>
        <Step img="/images/icons/saashq-12.svg" title="General">
          <GeneralStep formValues={formValues} handleState={handleState} />
        </Step>
        <Step img="/images/icons/saashq-03.svg" title="Options">
          <OptionsStep formValues={formValues} handleState={handleState} />
        </Step>
        <Step img="/images/icons/saashq-06.svg" title="Price">
          <PriceStep formValues={formValues} handleState={handleState} />
        </Step>
        <Step img="/images/icons/saashq-24.svg" title="Quantity">
          <QuantityStep formValues={formValues} handleState={handleState} />
        </Step>
        <Step img="/images/icons/saashq-21.svg" title="Repeat">
          <RepeatStep formValues={formValues} handleState={handleState} />
        </Step>
        <Step img="/images/icons/saashq-14.svg" title="Expiry">
