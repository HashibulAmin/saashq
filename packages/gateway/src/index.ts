...
import { retryGetProxyTargets, SaasHQProxyTarget } from './proxy/targets';
import {
...
import { connectionOptions } from '@saashq/api-utils/src/core';
...
(async () => {
  ...
  const targets: SaasHQProxyTarget[] = await retryGetProxyTargets();
