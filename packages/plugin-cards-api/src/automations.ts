    ...
    triggers: [
      {
        ...
        label: 'Úkol',
        description:
          'Začněte s prázdným pracovním postupem, který se zapíše a spustí mimo úlohu',
      },
      {
        type: 'cards:purchase',
        img: 'automation3.svg',
        ...
        label: 'Nákup',
        description:
          'Začněte s prázdným pracovním postupem, který se zaregistruje a spustí při nákupu',
      },
      {
        type: 'cards:ticket',
        img: 'automation3.svg',
        ...
        label: 'Lístek',
        description:
          'Začněte s prázdným pracovním postupem, který se zapíše a spustí z tiketu',
      },
      {
        type: 'cards:deal',
        img: 'automation3.svg',
        icon: 'piggy-bank',
        label: 'Prodejní potrubí',
        description:
          'Začněte s prázdným pracovním postupem, který se zaregistruje a spouští z položky prodejního kanálu',
      },
    ],
    actions: [
      {
      ...
      },
      {
        ...
        icon: 'file-plus-alt',
        label: 'Vytvořit nákup',
        description: 'Vytvořit nákup',
        isAvailable: true,
      },
      {
        type: 'cards:deal.create',
        icon: 'piggy-bank',
        label: 'Vytvořit dohodu',
        description: 'Vytvořit dohodu',
        isAvailable: true,
      },
      {
        type: 'cards:ticket.create',
        icon: 'file-plus',
        label: 'Vytvořit lístek',
        description: 'Vytvořit lístek',
        isAvailable: true,
      },
    ],
  },
