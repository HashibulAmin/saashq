...
class AutoAndManualForm extends React.Component<Props, State> {
  ...
  renderMessageContent() {
    ...
    const imagePath = '/images/icons/saashq-08.svg';
  ...
  renderRule() {
    ...
    return (
      <Step img="/images/icons/saashq-04.svg" title="Rule">
        <ConditionsRule
          rules={this.state.rules || []}
          onChange={this.changeState}
        />
  ...
  renderPreviewContent() {
    ...
    return (
      <Step
        img="/images/icons/saashq-19.svg"
        title="Full Preview"
        noButton={true}
      >
        <FullPreviewStep
    ...
    return (
      <StepWrapper>
        ...
        <Steps maxStep={4} active={1}>
          <Step img="/images/icons/saashq-05.svg" title="Choose channel">
            <ChannelStep
              onChange={this.changeState}
              method={this.state.method}
