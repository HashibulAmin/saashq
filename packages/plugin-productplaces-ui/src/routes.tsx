...
const routes = () => {
  return (
    <React.Fragment>
      <Route
        key="/saashq-plugin-product-places/settings/stage"
        exact={true}
        path="/saashq-plugin-product-places/settings/stage"
        component={StageSetting}
      />
      <Route
        key="/saashq-plugin-product-places/settings/split"
        exact={true}
        path="/saashq-plugin-product-places/settings/split"
        component={SplitSetting}
      />
      <Route
        key="/saashq-plugin-product-places/settings/print"
        exact={true}
        path="/saashq-plugin-product-places/settings/print"
