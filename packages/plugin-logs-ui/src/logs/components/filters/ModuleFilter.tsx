...
import { CustomPadding } from '@saashq/ui-contacts/src/customers/styles';
...
const moduleOptions = [
  ...
  { value: 'cards:deal', label: 'Nabídky' },
  { value: 'cards:purchase', label: 'Nákupy' },
  { value: 'cards:task', label: 'Úkoly' },
  { value: 'cards:ticket', label: 'Vstupenky' },
  ...
  { value: 'contacts:company', label: 'Společnosti' },
