...
import { Button, SortHandler, Table } from '@saashq/ui/src/components';
import WithPermission from 'coreui/withPermission';
import { Alert, __, confirm, formatValue } from '@saashq/ui/src/utils';
...
export default withRouter<IRouterProps, {}, React.Component<IProps>>(
  DetailDuplicated,
);
