...
const relations = (type) => {
  return [
    ...
    { name: 'dealIds', label: 'Nabídky', relationType: 'cards:deal' },
    { name: 'purchaseIds', label: 'Nákupy', relationType: 'cards:purchase' },
    { name: 'taskIds', label: 'Úkoly', relationType: 'cards:task' },
    { name: 'ticketIds', label: 'Vstupenky', relationType: 'cards:ticket' },
