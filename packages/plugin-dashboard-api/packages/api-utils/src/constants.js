...
exports.USER_ROLES = exports.DEFAULT_CONSTANT_VALUES = exports.SEX_OPTIONS = exports.DEFAULT_SEX_CHOICES = exports.SOCIAL_LINKS = exports.DEFAULT_SOCIAL_LINKS = exports.COMPANY_INDUSTRY_TYPES = exports.DEFAULT_COMPANY_INDUSTRY_TYPES = exports.COMPANY_BUSINESS_TYPES = exports.STATUSES = void 0;
exports.STATUSES = [
    { label: 'Active', value: 'Active' },
    { label: 'Deleted', value: 'Deleted' }
];
exports.COMPANY_BUSINESS_TYPES = [
    '',
    'Analyst',
    'Competitor',
    'Customer',
...
exports.DEFAULT_COMPANY_INDUSTRY_TYPES = [
    '',
    'Aerospace & Defense',
...
exports.COMPANY_INDUSTRY_TYPES = [...exports.DEFAULT_COMPANY_INDUSTRY_TYPES];
exports.DEFAULT_SOCIAL_LINKS = [
...
exports.DEFAULT_CONSTANT_VALUES = {
    sex_choices: exports.DEFAULT_SEX_CHOICES,
    company_industry_types: exports.DEFAULT_COMPANY_INDUSTRY_TYPES.map(v => ({
        label: v,
        value: v
    })),
    social_links: exports.DEFAULT_SOCIAL_LINKS
};
exports.USER_ROLES = {
    SYSTEM: 'system',
    USER: 'user',
