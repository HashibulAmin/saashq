...
exports.customFieldsDataByFieldCode = exports.generateFieldsFromSchema = void 0;
const generateFieldsFromSchema = async (queSchema, namePrefix) => {
    const fields = [];
    // field definitions
...
const customFieldsDataByFieldCode = async (object, subdomain, sendMessage) => {
    const customFieldsData = object.customFieldsData && object.customFieldsData.toObject
...
exports.customFieldsDataByFieldCode = customFieldsDataByFieldCode;
