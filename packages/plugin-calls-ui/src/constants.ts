export const all = [
  {
    details: {
      avatar:
        'https://saashq.s3.amazonaws.com/0.11660477860621943IMG_7287.PNG.png',
      fullName: 'Eduardo',
...
export const callActionButtons = [
  { icon: 'phone-times', text: 'Ztlumit' },
  { icon: 'pause-1', text: 'Držet' },
  { icon: 'play-circle', text: 'Záznam' },
];

export const inCallTabs = ['Poznámky', 'Tagy', 'Přiřadit'];
