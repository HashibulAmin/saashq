import { attachmentType } from '@saashq/api-utils/src/commonTypeDefs';
...
export const queries = `
  ...
  facebookGetIntegrationDetail(saashqApiId: String): JSON 
  ...
  facebookGetPost(saashqApiId: String): FacebookPost
