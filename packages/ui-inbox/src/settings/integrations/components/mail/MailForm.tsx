...
import { IEmail, IMail, IMessage } from '@saashq/ui-inbox/src/inbox/types';
...
import { isEnabled, readFile } from '@saashq/ui/src/utils/core';
...
import { IEmailSignature } from '@saashq/ui/src/auth/types';
...
const Signature = asyncComponent(
  () =>
    import(
      /* webpackChunkName:"Signature" */ '@saashq/ui-settings/src/email/containers/Signature'
    ),
);
