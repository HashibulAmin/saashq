...
const startChat = `public void onClick(View view) {
  ...
  config.start(email: "info@saashq.co", phone: "88998899", data: customData)
}`;
    ...
    if (currentTab === 'ios') {
      return (
        <>
          ...
          <ol>
            <li>
              {__('Add SaasHQ SDK to your iOS project in Xcode:')}
              <MarkdownWrapper>
                <pre>{iosSDK}</pre>
              </MarkdownWrapper>
          ...
          <ol>
            ...
            <li>
              {`#import <SaasHQSDK/SaasHQSDK-Swift.h> into`} AppDelegate.swift
            ...
            <li>
              ...
              <ol type="a">
                <li>
                  <b>{__('Without user data')}</b>
                  <MarkdownWrapper>
                    <pre>[SaasHQ startWithData:nil];</pre>
                  </MarkdownWrapper>
                </li>
                <li>
                  <b>{__('With user data')}</b>
      ...
      return (
        <ol>
          ...
          <li>
            ...
            <br />
            <b>* apiHost</b> - {__('saashq-widgets-api server url')} <br />
            <b>* subsHost</b> - {__('saashq-api subscription url')} <br />
            <b>* uploadUrl</b> - {__('saashq-api server url')}
            <MarkdownWrapper>
