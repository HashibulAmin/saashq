...
import ImageWithPreview from '@saashq/ui/src/components/ImageWithPreview';
import NameCard from '@saashq/ui/src/components/nameCard/NameCard';
import React from 'react';
import Tip from '@saashq/ui/src/components/Tip';
import dayjs from 'dayjs';
import { urlify } from '@saashq/ui/src/utils/urlParser';
import xss from 'xss';
...
export default class SimpleMessage extends React.Component<Props, {}> {
  renderAvatar() {
    return (
      <NameCard.Avatar
        user={{ _id: 'saashq_bot', username: 'bot', email: 'info@saashq.org' }}
      />
    );
  }
