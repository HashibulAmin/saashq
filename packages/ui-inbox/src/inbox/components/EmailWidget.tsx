...
import MailForm from '@saashq/ui-inbox/src/settings/integrations/containers/mail/MailForm';
import { ModalWrapper } from '../styles';
import React from 'react';
import Tip from '@saashq/ui/src/components/Tip';
import { WidgetWrapper } from '@saashq/ui-inbox/src/settings/integrations/components/mail/styles';
