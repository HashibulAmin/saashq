...
PROJECT_ID="saashq-gmail-$(echo $RANDOM)"
TOPIC="saashq-gmail-topic-$(echo $RANDOM)"
SUBSCRIPTION="saashq-gmail-subscription"
SERVICE_ACCOUNT="saashq-service-account-$(echo $RANDOM)"
...
(
  ...
  +==================================================================================================================+
     ...
     ${PURPLE}${BOLD}[ Navigate to SaasHQ [System config] and fill them as follows ]${RESET}
  ...
  References
  ==========
  Configure your Push Endpoint https://console.cloud.google.com/cloudpubsub/subscription/detail/saashq-gmail-subscription?project=${PROJECT_ID}
  "
