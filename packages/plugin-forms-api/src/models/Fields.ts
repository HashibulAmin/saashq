import { IOrderInput, updateOrder } from '@saashq/api-utils/src/commonUtils';
import { ILocationOption } from '@saashq/api-utils/src/types';
...
export interface IFieldModel extends Model<IFieldDocument> {
  ...
  checkIsDefinedBySaasHQ(_id: string): never;
...
export const loadFieldClass = (models: IModels, subdomain: string) => {
  class Field {
    ...
    public static async checkIsDefinedBySaasHQ(_id: string) {
      ...
      // Checking if the field is defined by the saashq
      if (fieldObj && fieldObj.isDefinedBySaasHQ) {
...
export const loadGroupClass = (models: IModels) => {
  class FieldGroup {
    ...
    public static async checkIsDefinedBySaasHQ(_id: string) {
      ...
      // Checking if the group is defined by the saashq
      if (groupObj && groupObj.isDefinedBySaasHQ) {
