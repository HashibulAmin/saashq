...
import { Alert, withProps, router as routerUtils } from '@saashq/ui/src/utils';
import { UserDetailQueryResponse } from '@saashq/ui/src/auth/types';
...
class PipelineProviderInner extends React.Component<Props, State> {
  ...
  onDragStart = (_start) => {
    ...
    if (!isDragEnabled) {
      throw new Error('Není připraven k pohybu...');
    }
  };
