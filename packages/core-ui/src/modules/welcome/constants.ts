...
export const SETUP = [
  {
    ...
    icon: 'cog',
    content:
      '<ol><li><b>Go to the settings and find System Configurations</b></li><li><b>Access General Settings. From here configure:</b><ul style="list-style-type: disc;"><li>Language (choose from 34 languages available)</li><li>Currency</li><li>Team members who can access every branches and departments</li></ul></li><li><b>Go to the Theme and set up:</b><ul style="list-style-type: disc;"><li>Logo</li><li>Favicon</li><li>Background</li><li>Text color</li><li>Motto</li><li>Login page description</li></ul></li><li><b>Configure additional settings</b> that are essential for you to begin using saashq, such as Cloudflare, AWS SES, and more.</li></ol>',
...
export const COMMUNITY = [
  ...
  { name: 'Twitter', link: 'https://twitter.com/saashqhq', icon: 'twitter' },
  {
    name: 'Facebook',
    link: 'https://www.facebook.com/saashqHQ/',
    icon: 'facebook',
  },
  {
    name: 'Blog',
...
export const VIDEO = [
  ...
  },
  {
    ...
    desc: 'How to install saashq messenger script code to integrate to your platform',
    icon: 'download-3',
