import { ColorPick, ColorPicker, ModalFooter } from '@saashq/ui/src/styles/main';
import { ExpandWrapper, MarkdownWrapper } from '@saashq/ui-settings/src/styles';
import {
  IAttachment,
  IButtonMutateProps,
  IFormProps
...
import { FlexContent } from '@saashq/ui/src/layout/styles';
...
import { LANGUAGES } from '@saashq/ui-settings/src/general/constants';
...
class KnowledgeForm extends React.Component<Props, State> {
  ...
  static getInstallTag() {
    return `
      <div data-saashq-kbase style="width:900px;height:300px"></div>
    `;
  }
      ...
      return (
        <>
          ...
          <FormGroup>
            <Info>
              {__(
                'Paste the tag below where you want saashq knowledgebase to appear'
              )}
            </Info>
