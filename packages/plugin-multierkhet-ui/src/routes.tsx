...
const routes = () => {
  return (
    <React.Fragment>
      <Route
        key="/saashq-plugin-multi-erkhet/settings/general"
        exact={true}
        path="/saashq-plugin-multi-erkhet/settings/general"
        component={GeneralSetting}
      />

      <Route
        key="/saashq-plugin-multi-erkhet/settings/stage"
        exact={true}
        path="/saashq-plugin-multi-erkhet/settings/stage"
        component={StageSetting}
      />

      <Route
        key="/saashq-plugin-multi-erkhet/settings/return-stage"
        exact={true}
        path="/saashq-plugin-multi-erkhet/settings/return-stage"
        component={ReturnStageSetting}
      />

      <Route
        key="/saashq-plugin-multi-erkhet/settings/pipeline"
        exact={true}
        path="/saashq-plugin-multi-erkhet/settings/pipeline"
