...
import { Formgroup } from '@saashq/ui/src/components/form/styles';
...
function General({
  ...
  return (
    <>
      ...
      <CollapseContent
        title={__('SaasHQ App Token')}
        compact={true}
        open={false}
      >
        {renderControl({
          label: 'SaasHQ App Token',
          formValueName: 'saashqAppToken',
          formValue: saashqAppToken,
        })}
      </CollapseContent>
    </>
  );
