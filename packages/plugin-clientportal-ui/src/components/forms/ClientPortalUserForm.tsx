...
import { Form } from '@saashq/ui/src/components/form';
...
class CustomerForm extends React.Component<Props, State> {
  constructor(props) {
    ...
    this.state = {
      ...
      req: true,
      activeSections,
      saashqCompanyId: clientPortalUser.saashqCompanyId,
  ...
  generateDoc = (
    ...
    const doc: any = {
      ...
      saashqCustomerId: finalValues.saashqCustomerId,
      saashqCompanyId: this.state.saashqCompanyId,
  ...
  onChangeCompany = saashqCompanyId => {
    this.setState({ saashqCompanyId });
  };
          ...
          <FormWrapper>
            <FormColumn>
              ...
              <FormGroup>
                ...
                <SelectCompanies
                  initialValue={clientPortalUser.saashqCompanyId}
