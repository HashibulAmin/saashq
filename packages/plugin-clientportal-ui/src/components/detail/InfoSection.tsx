import { Name, NameContainer } from '@saashq/ui-contacts/src/customers/styles';

import { AvatarWrapper } from '@saashq/ui-log/src/activityLogs/styles';
import ClientPortalUserForm from '../../containers/ClientPortalUserForm';
import { IClientPortalUser } from '../../types';
import Icon from '@saashq/ui/src/components/Icon';
import { InfoWrapper } from '@saashq/ui/src/styles/main';
