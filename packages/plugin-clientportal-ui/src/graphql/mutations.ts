...
const commonUserVariables = `
  ...
  avatar: $avatar
  saashqCompanyId: $saashqCompanyId
`;
...
const clientPortalUserAssignCompany = `
   mutation clientPortalUserAssignCompany($userId: String!, $saashqCompanyId: String!, $saashqCustomerId: String!){
    clientPortalUserAssignCompany(userId: $userId, saashqCompanyId: $saashqCompanyId, saashqCustomerId: $saashqCustomerId)
   }
`;
