...
import { FilterContainer, InputBar } from '@saashq/ui-settings/src/styles';

import Form from '@saashq/ui-emailtemplates/src/components/Form';
...
import { router } from '@saashq/ui/src';
import { IUserDetails } from '@saashq/ui/src/auth/types';
