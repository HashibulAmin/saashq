...
const SelectCustomers = asyncComponent(
  () =>
    isEnabled('contacts') &&
    import(
      /* webpackChunkName: "SelectCustomers" */ '@saashq/ui-contacts/src/customers/containers/SelectCustomers'
    )
);
...
const SelectCompanies = asyncComponent(
  () =>
    isEnabled('contacts') &&
    import(
      /* webpackChunkName: "SelectCustomers" */ '@saashq/ui-contacts/src/companies/containers/SelectCompanies'
    )
);
