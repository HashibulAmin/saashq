...
export const menuContracts = [
  {
    title: __('Contracts'),
    link: '/saashq-plugin-saving/contract-list',
    permission: 'showContracts',
  },
  {
    title: __('Deposit'),
    link: '/saashq-plugin-saving/deposit-list',
    permission: 'showContracts',
  },
  {
    title: __('Transactions'),
    link: '/saashq-plugin-saving/transaction-list',
    permission: 'showTransactions',
  },
  {
    title: __('PeriodLocks'),
    link: '/saashq-plugin-saving/periodLock-list',
