...
const SavingRoutes = () => {
  return (
    <React.Fragment>
      <Route
        key="/saashq-plugin-saving/contract-list"
        path="/saashq-plugin-saving/contract-list"
        exact={true}
        component={contractLists}
      />
      <Route
        key="/saashq-plugin-saving/deposit-list"
        path="/saashq-plugin-saving/deposit-list"
        exact={true}
        component={depositLists}
      />
      <Route
        path="/saashq-plugin-saving/contract-details/:id"
        component={detailsOfContract}
      />
      <Route
        path="/saashq-plugin-saving/transaction-list"
        component={transactionLists}
      />
      <Route
        path="/saashq-plugin-saving/contract-types"
        component={contractTypesLists}
      />
      <Route
        path="/saashq-plugin-saving/contract-type-details/:id"
        component={contractTypeDetail}
      />

      <Route
        path="/saashq-plugin-saving/holiday-settings"
        component={holidaySettings}
      />
      <Route
        path="/saashq-plugin-saving/periodLock-list"
        component={periodLockLists}
      />
      <Route
        path="/saashq-plugin-saving/periodLock-details/:id"
