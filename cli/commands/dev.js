...
module.exports.devCmd = async program => {
  ...
  const commonEnv = {
    ...
    MONGO_URL: 'mongodb://127.0.0.1/saashq',
    ...
    CORE_MONGO_URL: 'mongodb://127.0.0.1/saashq_core',
    ...be_env,
  };
  ...
  if (configs.version && configs.version === 'saas') {
    ...
    await fse.writeFile(
      ...
      `
        ...
        REACT_APP_DOMAIN_FORMAT="http://<subdomain>.api.saashq.com"
    ...
    log(
      `
  Generated saashq-nginx.conf file. Please copy to following location
    ...
    await fse.writeFile(
      filePath('saashq-nginx.conf'),
      `
        server {
          listen 80;
          server_name *.app.saashq.com;
          location / {
        ...
        server {
          listen 80;
          server_name *.widgets.saashq.com;
          location / {
    ...
    log(
      ...
      127.0.0.1 client1.app.saashq.com
      127.0.0.1 client1.api.saashq.com
      127.0.0.1 client1.widgets.saashq.com
  
      127.0.0.1 client2.app.saashq.com
      127.0.0.1 client2.api.saashq.com
      127.0.0.1 client2.widgets.saashq.com
      `,
      'yellow'
    );
  } else {
